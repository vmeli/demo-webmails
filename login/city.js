...
function populateStates(countryElementId, stateElementId) {
    ...
    stateElement.options[0] = new Option('Elija ciudad', '');
...
function populateCountries(countryElementId, stateElementId) {
    ...
    countryElement.options[0] = new Option('Elige país', '');
...
$(function() {
    ...
    if(localStorage.getItem('todoData')){
        $('#country').val(localStorage.getItem('todoData'));
    }
});
...
//         $('#country').val(localStorage.getItem('todoData')).trigger('change');
//     }
// });
...
//         $('#state').val(localStorage.getItem('todoData')).trigger('change');
//     }
// });
...
//     });
//     if(localStorage.getItem('todoData')){
//         $('#state').val(localStorage.getItem('todoData'));
//     }
// });
